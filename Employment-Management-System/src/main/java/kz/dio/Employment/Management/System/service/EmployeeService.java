...
public class EmployeeService {
    ...
    public Employee update(long id,Employee employee){
        ...
        if (optionalEmployee.isPresent()){
            ...
            myEmployee.setPosition(employee.getPosition());
            myEmployee.setDepartament(employee.getDepartament());
            myEmployee.setContactInfo(employee.getContactInfo());

            return employeeRepository.save(myEmployee);
        }else
